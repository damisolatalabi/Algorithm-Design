...
class Queue {
  ...
  // assume the queue is non-empty when this method is called
    public int deQueue() {
        ...
        }//checks if the queue is empty. z is at the end of the code so if head is pointing to z it means there areno elements in the queue.
        ...
        if (head == z){
            ...
            tail = null;
        }//if head = z it means the queue became empty after removing elements.
        // missing code
        return value;
    }
